...
class Zodiac extends Student{
  ...
  // Method to determine zodiac sign based on date and month   
    zodicSign(date : number , month : number){
        
        switch (month) {
            case 3:
                if (date >= 21) return "Aries";
                break;
            case 4:
                if (date <= 19) return "Aries";
                if (date >= 20) return "Taurus";
                break;
            case 5:
                if (date <= 20) return "Taurus";
                if (date >= 21) return "Gemini";
                break;
            case 6:
                if (date <= 20) return "Gemini";
                if (date >= 21) return "Cancer";
                break;
            case 7:
                if (date <= 22) return "Cancer";
                if (date >= 23) return "Leo";
                break;
            case 8:
                if (date <= 22) return "Leo";
                if (date >= 23) return "Virgo";
                break;
            case 9:
                if (date <= 22) return "Virgo";
                if (date >= 23) return "Libra";
                break;
            case 10:
                if (date <= 22) return "Libra";
                if (date >= 23) return "Scorpio";
                break;
            case 11:
                if (date <= 21) return "Scorpio";
                if (date >= 22) return "Sagittarius";
                break;
            case 12:
                if (date <= 21) return "Sagittarius";
                if (date >= 22) return "Capricorn";
                break;
            case 1:
                if (date <= 19) return "Capricorn";
                if (date >= 20) return "Aquarius";
                break;
            case 2:
                if (date <= 18) return "Aquarius";
                if (date >= 19) return "Pisces";
                break;
            case 3:
                if (date <= 20) return "Pisces";
                break;
            default:
                return "Invalid date";
        }
